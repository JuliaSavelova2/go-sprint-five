...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	speeds := r.meanSpeed()
	return ((CaloriesMeanSpeedMultiplier*speeds + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours)
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	speeds := w.meanSpeed() * 1000 / 3600
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(speeds, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours)
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	speeds := s.meanSpeed()
	return (speeds + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Training.Weight * s.Training.Duration.Hours()
